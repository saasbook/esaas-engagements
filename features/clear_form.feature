...
Scenario: user can reset a form for New App
	...
	And I fill in "App Description" with "this app is awesome" using nicEdit rich editor
...
Scenario: user can reset a form for New Organization
	...
	And I fill in "Description" with "this is my new org" using nicEdit rich editor
...
Scenario: user can reset a form for Create New User, Org, and App
	...
	And I select "Coach" from "User Type"
	And I fill in "SID" with "123123123"
	And I fill in "Organization Name" with "myNewOrg" using nicEdit rich editor
	And I fill in "Address Line 1" with "123 esaas street"
	And I fill in "Address Line 2" with "#789"
	And I fill in "City State Zip" with "Berkeley, CA 90000"
	And I fill in "Phone" with "123123123"
	And I fill in "Organization Description" with "this is my new org" using nicEdit rich editor
	And I fill in "Url" with "myneworg.com"
	And I check "Defunct"
	And I fill in "App Name" with "myNewApp"
	And I fill in "App Description" with "this app is awesome" using nicEdit rich editor
...
Scenario: user can reset a form for New Iteration
	...
	And I fill in "Customer Feedback" with "This is a general comment" using nicEdit rich editor
	And I press "Reset"
...
Scenario: user can reset a form for Edit App
	...
	And I fill in "random description" for "App Description" using nicEdit rich editor
	...
	And I should have filled in "Awesome!" for "App Description" using nicEdit rich editor
...
Scenario: user can reset a form for Edit Org
	...
	And I fill in "description for this app" for "Organization Description" using nicEdit rich editor
	And I check "Defunct"
	And I press "Reset"
...
Scenario: user can reset a form for Edit Iteration
	...
	And I fill in "some comment" for "Demeanor Comments" using nicEdit rich editor
	And I select "Mostly agree" from "Engagement"
	And I fill in "some comment" for "Engagement Comments" using nicEdit rich editor
	And I select "Neither agree nor disagree" from "Communication"
	And I fill in "some comment" for "Communication Comments" using nicEdit rich editor
	And I select "Strongly agree" from "Understanding"
	And I fill in "some comment" for "Understanding Comments" using nicEdit rich editor
	And I select "Strongly disagree" from "Effectiveness"
	And I fill in "some comment" for "Effectiveness Comments" using nicEdit rich editor
	And I select "Mostly disagree" from "Satisfaction"
	And I fill in "some comment" for "Satisfaction Comments" using nicEdit rich editor
	And I press "Reset"
