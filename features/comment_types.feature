...
Scenario: User can add new comments with different types
	Given I fill in "Write a comment..." with "This app needs to be revised." using nicEdit rich editor
...
Scenario: User can edit and choose different comment types
	Given I fill in "Write a comment..." with "This App is AWESOME!" using nicEdit rich editor
	And I press "Post"
	When I follow "Edit"
